# Extended CNN Study: Style, Geometry, and Relational Topology

> 本文档完整保留仓库早期以 VGG-19、HED、几何变换和镜像关系消融为中心的研究线。当前课程汇报的主线已经调整为根目录 `README.md` 与 10 分钟演示中的几何自编码器实验；本扩展研究及其代码、结果和报告均继续保留。
